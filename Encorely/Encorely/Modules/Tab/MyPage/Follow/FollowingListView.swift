...
struct FollowingListView: View {
    ...
    @StateObject private var vm = FollowingListViewModel()
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            List {
                ForEach(Array(vm.followings.enumerated()), id: \.element.id) { idx, user in
                    HStack(spacing: 12) {
...
#Preview { NavigationStack { FollowingListView() } }
