// Modules/Scrap/MyFolder1View.swift
import SwiftUI

struct MyFolder1View: View {
    ...
    @State private var folderName: String = "내가 만든 폴더 1"
    ...
    @StateObject private var vm = FolderViewModel(folderName: "내가 만든 폴더 1")
